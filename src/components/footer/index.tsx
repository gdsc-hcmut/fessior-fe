        ...
        <div className='leading-[28.8px] tracking-[0.32px] text-[#333333]'>
            <div className='relative flex flex-col overflow-hidden px-[24px] py-[40px] md:px-[40px] lg:flex-row lg:items-stretch lg:justify-between lg:px-[120px] lg:py-[60px]'>
                ...
                <div className='mb-[40px] lg:w-[600px]'>
                    ...
                    <p className='mb-[20px]'>
                        Fessior Community is a team of the Google Developer
                        Student Club - Ho Chi Minh City University.
                        Fessior&#39;s mission is to develop technology projects
                        which bring practical values to the society and build a
                        community of students who are passionate about
                        technology.
                    </p>
                    <div className='flex'>
