      ...
      <div className='flex items-end justify-between'>
        <div className='w-full md:w-fit'>
          ...
          <div className='flex items-center justify-between md:hidden'>
            ...
            <button className='flex h-10 w-10 items-center justify-center rounded-lg bg-primary'>
              <Image
        ...
        <button className='hidden h-10 w-10 items-center justify-center rounded-lg bg-primary md:flex xl:hidden'>
          <Image
            src='/icons/url/collections_bookmark.svg'
            alt='Sidebar toggle'
            width={0}
              ...
              (option, idx) =>
                option !== currentSortOption && (
                  <li
                    ...
                    className={clsx(
                      idx == 0 ||
                        (idx == 1 && currentSortOption === 'Latest' && 'pt-2'),
                      idx === sortOption.length - 1 && 'pb-2',
                      'w-full',
                    )}
                  >
