          ...
          <div className='w-[90%] md:w-[85%] xl:relative'>
            ...
            <div className=''>
              <button
                ...
                onClick={() =>
                  setTypeOfQR(typeOfQR === 'wifi' ? 'url' : 'wifi')
                }
              >
      ...
      <div>
        <div className='text-center md:flex md:flex-col md:items-center'>
          ...
          <p className='text-center leading-[24px] md:max-w-[640px]'>
            Your one-stop destination for essential utilities. Discover a world
            of community-driven tools that simplify your daily tasks.
          </p>
